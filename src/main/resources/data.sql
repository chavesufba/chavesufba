...
INSERT INTO SCHEMAA.SALA (NUMERO, CAPACIDADE, PAVILHAO_ID, TIPO, DESCRICAO_EQUIPAMENTOS) VALUES ('115', 22, 6, 'C', '20 computadores, 1 projetor, 2 caixas de som stereo');
...
INSERT INTO SCHEMAA.PESSOA (NOME, EMAIL, LOGIN, SENHA) VALUES ('Teste Bcrypt', 'teste@teste.com', 'bcrypt', '$2a$10$dwlhFoQV5CpZhR0.8HReROW9/te7v54yMJIhfDgiUkutwgf2BVs56');
INSERT INTO SCHEMAA.TECNICO (DEPARTAMENTO_ID, PESSOA_ID) VALUES (1, 4);

INSERT INTO SCHEMAA.PROFESSOR (NUM_SIAP, DEPARTAMENTO_ID, PESSOA_ID, PROFESSOR_VISITANTE) VALUES ('123323456', 1, 3, FALSE);
...
INSERT INTO SCHEMAA.ALUNO (MATRICULA, PESSOA_ID, CURSO_ID, ALUNO_VISITANTE) VALUES ('213345673', 1, 2, FALSE);
INSERT INTO SCHEMAA.ALUNO (MATRICULA, PESSOA_ID, CURSO_ID, ALUNO_VISITANTE) VALUES ('435563578', 2, 2, FALSE);

INSERT INTO SCHEMAA.RESERVA (PROFESSOR_ID, SALA_ID, HORA_INICIO, HORA_FINAL, TECNICO_ID, STATUS_RESERVA) VALUES (1, 1, '2016-09-09 12:45:00', '2016-09-09 14:45:00',  1, 'P');
INSERT INTO SCHEMAA.RESERVA (PROFESSOR_ID, SALA_ID, HORA_INICIO, HORA_FINAL, TECNICO_ID, STATUS_RESERVA) VALUES (1, 2, '2016-09-09 10:00:00', '2016-09-09 12:00:00',  1, 'A');
INSERT INTO SCHEMAA.RESERVA (PROFESSOR_ID, SALA_ID, HORA_INICIO, HORA_FINAL, TECNICO_ID, STATUS_RESERVA) VALUES (1, 3, '2016-09-08 10:00:00', '2016-09-08 12:00:00',  1, 'R');

INSERT INTO SCHEMAA.LOCACAO (SALA_ID, HORA_INICIO, HORA_FINAL, PESSOA_ID) VALUES (1, '2016-09-09 12:45:00', '2016-09-09 14:45:00', 3);

-- TODO: ADD RESERVA, PERMISSAO
