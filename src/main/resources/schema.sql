...
CREATE TABLE IF NOT EXISTS SCHEMAA.ACAO
(
	ID INTEGER NOT NULL AUTO_INCREMENT,
	DESCRICAO VARCHAR(50) NOT NULL,
...
(
	...
	CONSTRAINT FK_PERMISSAO_ACAO FOREIGN KEY (ACAO_ID) REFERENCES SCHEMAA.ACAO(ID) ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
(
	...
	CONSTRAINT FK_LOCACAO_PESSOA FOREIGN KEY (PESSOA_ID) REFERENCES SCHEMAA.PESSOA(ID) ON UPDATE NO ACTION ON DELETE NO ACTION,
